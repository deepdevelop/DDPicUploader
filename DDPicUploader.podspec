#
#  Be sure to run `pod spec lint DDPicUploader.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/deepdevelop/DDPicUploader.git", :tag => "1.1.1" }
  ...
  s.source_files  = "DDPicClient/**/*.{h,m}"
